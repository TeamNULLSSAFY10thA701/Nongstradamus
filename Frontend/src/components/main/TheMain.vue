<template>
  <div class="all-font max-w-md mx-auto">
    ...
    <div class="w-2/5 mx-auto p-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
          ...
          <Slide v-for="slide in lastWeekPrice.data" :key="slide">
            <div>
              <a class="block p-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
                ...
                <div class="ratio w-full mx-auto">
...
function BigImage2() {
  ...
  //hover 시, 가격을 전날대비 등락폭으로 만드는 메서드
}
...
function SmallImage2() {
  ...
  //hover 시, 전날대비 등락폭에서 가격으로 만드는 메서드 
}
